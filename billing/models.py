...
class BillingProfile(models.Model):
    ...
    def set_cards_inactive(self):
        ...
        return card_qs.filter(active=False).count()
...
class ChargeManager(models.Manager):
    def do(self, billing_profile, order_obj, card=None):
        ...
        new_charge_boj.save()
        return new_charge_boj.paid, new_charge_boj.seller_message
...
class Charge(models.Model):
    ...
    outcometype = models.CharField(max_length=120, null=True, blank=True)
